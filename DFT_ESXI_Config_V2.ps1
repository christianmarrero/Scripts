...
$esxcli=get-esxcli -VMHost $esxi
$esxcli.storage.nmp.satp.rule.add($null, "tpgs_on", "3PAR FlashArray RR IO Operation Limit Rule", $null, $null, $null, "VV",
$null, "VMW_PSP_RR", "iops=1", "VMW_SATP_ALUA", $null, $null, "3PARdata")
